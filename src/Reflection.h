...
extern "C" long getFieldShort(jobject, char*) __attribute__((stdcall));
extern "C" long getFieldByte(jobject, char*) __attribute__((stdcall));
...
extern "C" bool isPathValid(jobject, char*) __attribute__((stdcall));
