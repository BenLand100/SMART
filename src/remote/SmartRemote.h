...
#define setMode              FirstFunc+22

#define ExtraFuncs           FirstFunc+23
...
extern "C" bool exp_isKeysEnabled();
...
extern "C" void exp_setMode(int mode);
...
static char* exports[] = {
    ...
    (char*)"exp_isKeysEnabled", (char*)"function SmartKeysEnabled: boolean;",
    (char*)"exp_isMouseEnabled", (char*)"function SmartMouseEnabled: boolean;",
    ...
    (char*)"exp_setMode", (char*)"procedure SmartSetMode(mode: Integer);",
