...
static char* exports[] = {
    ...
    (char*)"dragMouse@8", (char*)"procedure SmartDragMouse(x, y: Integer);",
    (char*)"clickMouse@12", (char*)"procedure SmartClickMouse(x, y: Integer; left: Boolean);",
    (char*)"sendKeys@4", (char*)"procedure SmartSendKeys(Text: AnsiString);",
    (char*)"holdKey@4", (char*)"procedure SmartHoldKey(Code: Integer);",
    (char*)"isKeyDown@4", (char*)"function SmartIsKeyDown(Code: Integer): Boolean;",
    (char*)"releaseKey@4", (char*)"procedure SmartReleaseKey(Code: Integer);",
    (char*)"getColor@8", (char*)"function SmartGetColor(x, y: integer): integer;",
    ...
    (char*)"findColorSpiral@28", (char*)"function SmartFindColorSpiral(var x, y: integer; color, sx, sy, ex, ey: integer): boolean;",
    (char*)"findColorSpiralTol@32", (char*)"function SmartFindColorSpiralTolerance(var x, y: integer; color, sx, sy, ex, ey, tol: integer): boolean;",
    (char*)"stringFromBytes@8", (char*)"function SmartStringFromBytes(bytes: integer; str: AnsiString): integer;",
    ...
    (char*)"getFieldFloat@8", (char*)"function SmartGetFieldFloat(parent: integer; path: AnsiString): extended;",
    (char*)"getFieldDouble@8", (char*)"function SmartGetFieldDouble(parent: integer; path: AnsiString): extended;",
    (char*)"getFieldBool@8", (char*)"function SmartGetFieldBoolean(parent: integer; path: AnsiString): boolean;",
    (char*)"getFieldLongH@8", (char*)"function SmartGetFieldLongH(parent: integer; path: AnsiString): integer;",
    (char*)"getFieldLongL@8", (char*)"function SmartGetFieldLongL(parent: integer; path: AnsiString): integer;",
    (char*)"getFieldArrayInt@12", (char*)"function SmartGetFieldArrayInt(parent: integer; path: AnsiString; index: integer): integer;",
    (char*)"getFieldArrayFloat@12", (char*)"function SmartGetFieldArrayFloat(parent: integer; path: AnsiString; index: integer): extended;",
    (char*)"getFieldArrayDouble@12", (char*)"function SmartGetFieldArrayDouble(parent: integer; path: AnsiString; index: integer): extended;",
    (char*)"getFieldArrayLongH@12", (char*)"function SmartGetFieldArrayLongH(parent: integer; path: AnsiString; index: integer): integer;",
    (char*)"getFieldArrayLongL@12", (char*)"function SmartGetFieldArrayLongL(parent: integer; path: AnsiString; index: integer): integer;",
    (char*)"getFieldArrayBool@12", (char*)"function SmartGetFieldArrayBoolean(parent: integer; path: AnsiString; index: integer): boolean;",
    (char*)"getFieldArrayByte@12", (char*)"function SmartGetFieldArrayByte(parent: integer; path: AnsiString; index: integer): integer;",
    (char*)"getFieldArrayShort@12", (char*)"function SmartGetFieldArrayShort(parent: integer; path: AnsiString; index: integer): integer;",
    (char*)"getFieldArrayChar@12", (char*)"function SmartGetFieldArrayChar(parent: integer; path: AnsiString; index: integer): integer;",
    (char*)"getFieldArray3DInt@20", (char*)"function SmartGetFieldArray3DInt(parent: integer; path: AnsiString; x ,y, z: integer): integer;",
    (char*)"getFieldArray3DFloat@20", (char*)"function SmartGetFieldArray3DFloat(parent: integer; path: AnsiString; x ,y, z: integer): extended;",
    (char*)"getFieldArray3DDouble@20", (char*)"function SmartGetFieldArray3DDouble(parent: integer; path: AnsiString; x ,y, z: integer): extended;",
    (char*)"getFieldArray3DBool@20", (char*)"function SmartGetFieldArray3DBoolean(parent: integer; path: AnsiString; x ,y, z: integer): boolean;",
    (char*)"getFieldArray3DLongH@20", (char*)"function SmartGetFieldArray3DLongH(parent: integer; path: AnsiString; x ,y, z: integer): integer;",
    (char*)"getFieldArray3DLongL@20", (char*)"function SmartGetFieldArray3DLongL(parent: integer; path: AnsiString; x ,y, z: integer): integer;",
    (char*)"getFieldArray3DByte@20", (char*)"function SmartGetFieldArray3DByte(parent: integer; path: AnsiString; x ,y, z: integer): integer;",
    (char*)"getFieldArray3DShort@20", (char*)"function SmartGetFieldArray3DShort(parent: integer; path: AnsiString; x ,y, z: integer): integer;",
    (char*)"getFieldArray3DChar@20", (char*)"function SmartGetFieldArray3DChar(parent: integer; path: AnsiString; x ,y, z: integer): integer;",
    (char*)"getFieldArray3DObject@20", (char*)"function SmartGetFieldArray3DObject(parent: integer; path: AnsiString; x ,y, z: integer): integer;",
    (char*)"getFieldArray2DInt@16", (char*)"function SmartGetFieldArray2DInt(parent: integer; path: AnsiString; x ,y: integer): integer;",
    (char*)"getFieldArray2DFloat@16", (char*)"function SmartGetFieldArray2DFloat(parent: integer; path: AnsiString; x ,y: integer): extended;",
    (char*)"getFieldArray2DDouble@16", (char*)"function SmartGetFieldArray2DDouble(parent: integer; path: AnsiString; x ,y: integer): extended;",
    (char*)"getFieldArray2DBool@16", (char*)"function SmartGetFieldArray2DBoolean(parent: integer; path: AnsiString; x ,yz: integer): boolean;",
    (char*)"getFieldArray2DLongH@16", (char*)"function SmartGetFieldArray2DLongH(parent: integer; path: AnsiString; x ,y: integer): integer;",
    (char*)"getFieldArray2DLongL@16", (char*)"function SmartGetFieldArray2DLongL(parent: integer; path: AnsiString; x ,y: integer): integer;",
    (char*)"getFieldArray2DByte@16", (char*)"function SmartGetFieldArray2DByte(parent: integer; path: AnsiString; x ,y: integer): integer;",
    (char*)"getFieldArray2DShort@16", (char*)"function SmartGetFieldArray2DShort(parent: integer; path: AnsiString; x ,y: integer): integer;",
