...
static char* exports[] = {
    ...
    (char*)"exp_setRefresh", (char*)"procedure SmartSetRefresh(target: "PTR"; x: integer);",
    (char*)"exp_setTransparentColor", (char*)"procedure SmartSetTransparentColor(target: "PTR"; color: integer);",
    (char*)"exp_setDebug", (char*)"procedure SmartSetDebug(target: "PTR"; enabled: boolean);",
    (char*)"exp_setGraphics", (char*)"procedure SmartSetGraphics(target: "PTR"; enabled: boolean);",
    (char*)"exp_setEnabled", (char*)"procedure SmartSetEnabled(target: "PTR"; enabled: boolean);",
    (char*)"exp_isActive", (char*)"function SmartActive(target: "PTR"): boolean;",
    (char*)"exp_isBlocking", (char*)"function SmartEnabled(target: "PTR"): boolean;",
    (char*)"exp_getMousePos", (char*)"procedure SmartGetMousePos(target: "PTR"; var x, y: integer);",
    (char*)"exp_holdMouse", (char*)"procedure SmartHoldMouse(target: "PTR"; x, y: integer; left: boolean);",
    (char*)"exp_releaseMouse", (char*)"procedure SmartReleaseMouse(target: "PTR"; x, y: integer; left: boolean);",
    (char*)"exp_holdMousePlus", (char*)"procedure SmartHoldMousePlus(target: "PTR"; x, y, button: integer);",
    (char*)"exp_releaseMousePlus", (char*)"procedure SmartReleaseMousePlus(target: "PTR"; x, y, button: integer);",
    (char*)"exp_moveMouse", (char*)"procedure SmartMoveMouse(target: "PTR"; x, y: integer);",
    (char*)"exp_windMouse", (char*)"procedure SmartWindMouse(target: "PTR"; x, y: integer);",
    (char*)"exp_clickMouse", (char*)"procedure SmartClickMouse(target: "PTR"; x, y: integer; left: boolean);",
    (char*)"exp_clickMousePlus", (char*)"procedure SmartClickMousePlus(target: "PTR"; x, y, button: integer);",
    (char*)"exp_isMouseButtonHeld", (char*)"function SmartIsMouseButtonHeld(target: "PTR"; button: integer): boolean;",
    (char*)"exp_scrollMouse", (char*)"procedure SmartScrollMouse(target: "PTR"; x, y, lines: integer);",
    (char*)"exp_sendKeys", (char*)"procedure SmartSendKeys(target: "PTR"; Text: String; keywait, keymodwait: integer);",
    (char*)"exp_holdKey", (char*)"procedure SmartHoldKey(target: "PTR"; Code: Integer);",
    (char*)"exp_releaseKey", (char*)"procedure SmartReleaseKey(target: "PTR"; Code: Integer);",
    (char*)"exp_isKeyDown", (char*)"function SmartIsKeyDown(target: "PTR"; Code: Integer): Boolean;",
    (char*)"exp_setCapture", (char*)"procedure SmartSetCapture(target: "PTR"; enabled: boolean);",
    (char*)"exp_setNativeBtn", (char*)"procedure SmartSetNativeButton(target: "PTR"; plugid,btnid: integer; state: boolean);",
    (char*)"exp_getFieldObject", (char*)"function SmartGetFieldObject(target: "PTR"; objref: "PTR"; path: string): "PTR";",
    (char*)"exp_isPathValid", (char*)"function SmartIsPathValid(target: "PTR"; objref: "PTR"; path: string): boolean;",
    (char*)"exp_getFieldBoolean", (char*)"function SmartGetFieldBoolean(target: "PTR"; objref: "PTR"; path: string): boolean;",
    (char*)"exp_getFieldLongH", (char*)"function SmartGetFieldLongH(target: "PTR"; objref: "PTR"; path: string): integer;",
    (char*)"exp_getFieldLongL", (char*)"function SmartGetFieldLongL(target: "PTR"; objref: "PTR"; path: string): integer;",
    (char*)"exp_getFieldInt", (char*)"function SmartGetFieldInt(target: "PTR"; objref: "PTR"; path: string): integer;",
    (char*)"exp_getFieldShort", (char*)"function SmartGetFieldShort(target: "PTR"; objref: "PTR"; path: string): integer;",
    ...
    (char*)"exp_stringFromChars", (char*)"function SmartStringFromChars(target: "PTR"; chars: "PTR"; str: String): integer;",
    (char*)"exp_isEqual", (char*)"function SmartIsEqual(target: "PTR"; obja, objb: "PTR"): boolean;",
    (char*)"exp_isNull", (char*)"function SmartIsNull(target: "PTR"; obj: "PTR"): boolean;",
};
